      ...
      <div className="collection">
        <div className="collection-intro">
          ...
          <p className="explanation">
            ...
            that, I signed for other courses following a frontend roadmap
            including React.js, Vue.js and Node.js which are based on
            JavaScript. This collection will be a great example to show how I
            have constantly worked myself to achieve my goal to be a frontend
            developer!
          </p>
        </div>
